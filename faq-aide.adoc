...
No. El DCN es un nodo de hardware de computación de datos proporcionado por NetApp y es el único mecanismo de despliegue para AIDE.
...
AIDE Console es una interfaz de gestión independiente que se ejecuta en los DCN. Tú usas AIDE Console para gestionar los servicios de AIDE, como Data Guardrails y Data Curator. También puedes usar ONTAP System Manager para monitorear el clúster de AIDE.
