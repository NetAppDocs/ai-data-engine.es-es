...
.Antes de empezar
* Necesitas privilegios de _administrador de almacenamiento_ en AI Data Engine Console (`\https://<cluster_management_ip>/console` para crear y gestionar políticas globales.
...
* link:../vectorization/view-data-collections.html["Ver colecciones de datos en AI Data Engine"]
* link:../vectorization/zero-to-rag.html["Inicio rápido de Data-to-RAG para AI Data Engine"]
