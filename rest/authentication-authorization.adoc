...
OpenID Connect (OIDC) se basa en OAuth 2.0 y proporciona una opción segura y estandarizada a la hora de autenticar usuarios y aplicaciones. Se requiere OIDC para acceder a la funcionalidad de DCN y AIDE. Después de link:../install-setup/configure-oidc.html["Configura OpenID Connect para AIDE en ONTAP"], el acceso a ONTAP System Manager y a la página Swagger on-box están protegidos por la autenticación OIDC.
