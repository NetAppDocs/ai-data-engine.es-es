...
.Antes de empezar
* Necesitas privilegios de _data engineer_ o _data scientist_ en AIDE Console (`\https://<cluster_management_ip>/console`).
...
* La licencia del software AIDE está instalada y las funciones de inferencia están habilitadas.
