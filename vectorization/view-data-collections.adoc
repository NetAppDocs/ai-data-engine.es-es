...
* La licencia del software AIDE está instalada y las funciones de inferenciación están habilitadas, así que los endpoints de vectorización y recuperación están activos.
