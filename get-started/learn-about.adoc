...
. **Creación de colecciones de datos**: Los ingenieros de datos y los científicos de datos usan AIDE Console para consultar el catálogo de metadatos, filtrar resultados y armar colecciones de datos seleccionadas para tareas específicas de IA.
